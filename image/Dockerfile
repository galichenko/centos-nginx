...
COPY ./config/config.xml /tmp/config.xml
...
COPY ./config/plugins_extra.txt /tmp/plugins_extra.txt
RUN /usr/local/bin/install-plugins.sh $(cat /tmp/plugins_extra.txt  | tr '\n' ' ')
